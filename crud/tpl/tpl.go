...
func mgoGoTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "mgo.go.tpl", size: 6263, mode: os.FileMode(420), modTime: time.Unix(1551720131, 0)}
